...
## Environments
- Preview: https://main--aem-eds-blog-scheme--jlopellicer.aem.page/
- Live: https://main--aem-eds-blog-scheme--jlopellicer.aem.live/
...
1. Open the `aem-eds-blog-scheme` directory in your favorite IDE and start coding :)
