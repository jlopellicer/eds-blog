   ...
   <div class="">
      <div class="container">
         <div class="block-text-sup">
            ...
            <div class="ac-title">
               <h2 class="ac-headline-h2">Artículos por categorías</h2>
            </div>
         </div>
         <div class="block-generic">
            ...
            <div class="block-single">
               <div class="block-info analyticBenefitsCta1">
                  ...
                  <div class="ac-typeTagL">
                     <p><b>MOVILIDAD SOSTENIBLE</b></p>
                  </div>
                  <div class="ac-typeBodyM">
                     <p>Moverte de forma ecológica para crear ciudades más limpias.</p>
                  </div>
                  <div class="link ac-typeTagS analyticPreFooter" style="
                     margin-top: 20px;
                     ">
            ...
            <div class="block-single">
               <div class="block-info analyticBenefitsCta1">
                  ...
                  <div class="ac-typeTagL">
                     <p><b>HOGARES EFICIENTES</b></p>
                  </div>
                  <div class="ac-typeBodyM">
                     <p>Optimiza el consumo energético que haces en tu vivienda</p>
                  </div>
                  <div class="link ac-typeTagS analyticPreFooter" style="
                     margin-top: 20px;
                     ">
            ...
            <div class="block-single">
               <div class="block-info analyticBenefitsCta1">
                  ...
                  <div class="ac-typeTagL">
                     <p><b>AHORRO ENERGÉTICO</b></p>
                  </div>
                  <div class="ac-typeBodyM">
                     <p>Estrategias para reducir consumo y costes energéticos.</p>
                  </div>
                  <div class="link ac-typeTagS analyticPreFooter" style="
                     margin-top: 20px;
                     ">
            ...
            <div class="block-single">
               <div class="block-info analyticBenefitsCta1">
                  ...
                  <div class="ac-typeTagL">
                     <p><b>ENERGÍAS QUE CUIDAN DEL PLANTENA</b></p>
                  </div>
                  <div class="ac-typeBodyM">
                     <p>Infórmate sobre como podemos construir un mundo más sostenible entre todos.</p>
                  </div>
                  <div class="link ac-typeTagS analyticPreFooter" style="
                     margin-top: 20px;
                     ">
            ...
            <div class="block-single">
               <div class="block-info analyticBenefitsCta1">
                  ...
                  <div class="ac-typeTagL">
                     <p><b>EL FUTURO DE LA ENERGÍA</b></p>
                  </div>
                  <div class="ac-typeBodyM">
                     <p>Innovaciones que transformarán el sector energético.</p>
                  </div>
                  <div class="link ac-typeTagS analyticPreFooter" style="
                     margin-top: 20px;
                     ">
